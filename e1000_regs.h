...
/* ============================================
 * RDMA Extension Registers
 * Base offset: 0x5800
 * ============================================ */

/* RDMA Control and Status */
#define E1000_RDMA_CTRL    0x05800  /* RDMA Control Register - RW */
#define E1000_RDMA_STATUS  0x05804  /* RDMA Status Register - RO */
#define E1000_MR_TABLE_PTR 0x05808  /* Memory Region Table Pointer - RW */
#define E1000_MR_TABLE_LEN 0x0580C  /* MR Table Length - RW */
#define E1000_MR_TABLE_IDX 0x05810  /* MR Table Index - RW */

/* RDMA Control Register Bits */
#define E1000_RDMA_CTRL_ENABLE  (1 << 0)  /* Enable RDMA */
#define E1000_RDMA_CTRL_RESET   (1 << 1)  /* Reset RDMA state */
#define E1000_RDMA_CTRL_VALID   (1 << 2)  /* Config valid */

/* RDMA Status Register Bits */
#define E1000_RDMA_STATUS_READY (1 << 0)  /* RDMA ready */
#define E1000_RDMA_STATUS_ERROR (1 << 1)  /* Error occurred */
#define E1000_RDMA_STATUS_BUSY  (1 << 2)  /* Processing work */

/* Queue Pair Registers Base */
#define E1000_QP_BASE      0x05900  /* QP register base */
#define E1000_QP_STRIDE    0x0020   /* 32 bytes per QP */
#define E1000_QP_COUNT     16       /* Support 16 QPs */

/* Per-QP Register Offsets (relative to QP base) */
#define E1000_QP_SQ_BASE   0x00  /* Send Queue Base Address - RW */
#define E1000_QP_SQ_SIZE   0x08  /* Send Queue Size - RW */
#define E1000_QP_SQ_HEAD   0x0C  /* Send Queue Head - RO */
#define E1000_QP_SQ_TAIL   0x10  /* Send Queue Tail - RW */
#define E1000_QP_CQ_BASE   0x14  /* Completion Queue Base - RW */
#define E1000_QP_CQ_SIZE   0x18  /* Completion Queue Size - RW */
#define E1000_QP_CQ_HEAD   0x1C  /* Completion Queue Head - RW */
#define E1000_QP_CQ_TAIL   0x20  /* Completion Queue Tail - RO */

/* Helper macros for QP register addresses */
#define E1000_QP_REG(qp, offset) \
    (E1000_QP_BASE + (qp) * E1000_QP_STRIDE + (offset))

/* RDMA Packet Ethertype */
#define ETH_P_RDMA         0x8915  /* Custom RDMA protocol */
